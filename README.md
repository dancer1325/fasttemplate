...
* == Go template engine 
  * is 
    ...
    * fast
  * goal
    * ⭐️substitutes template placeholders -- with -- user-defined values⭐️
  * ❌NOT escape template values❌
  * ❌NOT use cases❌
    * html template engine
      * -> use [quicktemplate](https://github.com/valyala/quicktemplate)
  * about placeholders' substitution,
    * vs [text/template](http://golang.org/pkg/text/template/)
      * faster
